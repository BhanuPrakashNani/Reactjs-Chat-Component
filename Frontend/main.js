...
class App extends React.Component {
    ...
    render() {
      ...
      return (// React can only ONE component render at a time . I you want to render more, then you need to add a div or someting.
        <Chatapp authenticated="true" servername="SlaBot" welcomemessage="Welcome to ChatApp (^=^)" uri="localhost:9000"  hardpath="/socket.io" reconnect="true" resource="/" secure="false" />
